...
namespace ChatProject.Migrations
{
    ...
    [Migration("20250228135627_ChangedFilesToConnectWithMessages")]
    partial class ChangedFilesToConnectWithMessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChatProject.Models.Files.ChatFileNameMap", b =>
                {
                    ...
                    b.Property<Guid>("ChatFileStreamId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ChatProject.Models.Files.ChatFileNameMap", b =>
                {
                    b.HasOne("ChatProject.Models.Files.ChatFile", "ChatFile")
                        ...
                        .HasForeignKey("ChatFileStreamId")
